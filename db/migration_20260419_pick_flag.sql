...
-- Add pick_flag column to watchlist if it doesn't exist
ALTER TABLE watchlist
ADD COLUMN IF NOT EXISTS pick_flag TINYINT(1) DEFAULT 0;

-- Add index for pick_flag if it doesn't exist
ALTER TABLE watchlist
ADD INDEX IF NOT EXISTS idx_pick_flag (pick_flag);

-- Add signal_count column to stock_signals if it doesn't exist
ALTER TABLE stock_signals
ADD COLUMN IF NOT EXISTS signal_count INT DEFAULT 5;
